...
def get_optional_user(
    ...
    try:
        ...
        return None
""",
<parameter name="Description">Core security module providing JWT auth, password hashing, and FastAPI user dependencies. Uses passlib/bcrypt for passwords and python-jose for JWT tokens.
